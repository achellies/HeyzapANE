...
static FREObject load(FREContext ctx, void* funcData, uint32_t argc, FREObject argv[])
{
    ...
    [HeyzapSDK startHeyzapWithAppId: [NSString stringWithUTF8String:(char*)appStoreId]];
    [[HeyzapSDK sharedSDK] setAppURL: [NSURL URLWithString: [NSString stringWithUTF8String:(char*)appURL]]];
